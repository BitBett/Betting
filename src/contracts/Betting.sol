...
contract Betting {
   ...
   uint public totalBetsOne = 0 ;
   uint public totalBetsTwo = 0;
  ...
  function bet(uint8 _teamSelected) public payable {
      ...
      emit BettingDone(msg.value, _teamSelected);
    }

    
    function finaliseWinners(uint16 teamWinner) public {
      address payable[1000] memory winners;
      address payable[1000] memory loosers;
      //We have to create a temporary in memory array with fixed size
      //Let's choose 1000
      uint256 count = 0; // This is the count for the array of winners
      uint256 loosersCount = 0; // This is the count for the array of winners
      ...
      for(uint256 i = 0; i < players.length; i++){
         ...
         if(playerInfo[playerAddress].teamSelected == teamWinner){
            ...
            loosers[loosersCount++] = playerAddress;
         }
       }
